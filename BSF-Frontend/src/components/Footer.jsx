    ...
    <footer className="bg-gradient-to-r from-bsf-green to-mint-600 text-white w-full">
      <div className="container py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Column 1 */}
          <div>
            <h3 className="text-lg font-bold mb-4">BASIS Student Forum</h3>
            <p className="text-white/80 text-sm">
              Green University of Bangladesh<br />
              Begum Rokeya Avenue, Dhaka
            </p>
            <div className="mt-4 flex space-x-3">
              <a href="#" className="text-white hover:text-bsf-teal">
          ...
          <div>
            ...
            <form className="flex">
              <input 
                ...
                className="px-3 py-2 text-sm bg-white/10 rounded-l-md focus:outline-none focus:ring-1 focus:ring-bsf-teal flex-grow"
              />
              <button 
                type="submit"
                className="bg-bsf-red hover:bg-bsf-teal transition-colors text-white px-4 py-2 rounded-r-md text-sm"
              >
                Subscribe
              </button>
            </form>
