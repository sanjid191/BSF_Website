...
export default function Events() {
  ...
  return (
    <motion.div 
      ...
      className="container px-4 sm:px-6 py-8 sm:py-10 md:py-12"
    >
      {/* Hero section */}
      <div className="relative bg-gradient-to-r from-bsf-green to-bsf-teal rounded-lg sm:rounded-xl md:rounded-2xl mb-6 sm:mb-8 md:mb-12 lg:mb-16 overflow-hidden max-w-section mx-auto">
        <div className="absolute inset-0 bg-grid-pattern opacity-10"></div>
        <div className="absolute top-10 right-10 w-20 sm:w-40 h-20 sm:h-40 bg-white/10 rounded-full blur-2xl"></div>
        <div className="py-10 sm:py-12 md:py-16 px-6 sm:px-8 relative z-10">
          <motion.div 
            variants={fadeIn}
          ...
          >
            ...
            <p className="text-white/90 text-base sm:text-lg mb-0 max-w-2xl mx-auto">
      ...
      <div className="mb-6 sm:mb-8 md:mb-10 flex flex-col space-y-4 sm:space-y-6">
        {/* Tabs */}
        <div className="flex justify-center">
          <div className="inline-flex bg-white/80 backdrop-blur-sm p-1 sm:p-1.5 rounded-full shadow-md">
            <button
              onClick={() => {
              ...
              className={`px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium transition-all ${
                activeTab === 'upcoming' 
        ...
        {/* Category filters */}
        <div className="flex justify-center">
          <div className="inline-flex flex-wrap justify-center bg-white/50 backdrop-blur-sm p-1 sm:p-1.5 rounded-lg sm:rounded-xl shadow-sm max-w-full overflow-x-auto">
            <div className="flex flex-wrap justify-center">
              {tabCategories.map(category => (
                <button
                  ...
                  className={`m-0.5 sm:m-1 px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 rounded-full text-xs font-medium transition-all whitespace-nowrap ${
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 md:gap-8">
        {/* Events grid */}
        <div className={`${selectedEvent ? 'lg:col-span-7' : 'lg:col-span-12'} grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-${selectedEvent ? '2' : '3'} gap-3 sm:gap-4 md:gap-6`}>
          {filteredEvents.length > 0 ? (
            filteredEvents.map((event, index) => (
              <motion.div
                ...
                className={`bg-white rounded-lg sm:rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all cursor-pointer transform hover:-translate-y-1 ${
              ...
              >
                ...
                <div className="p-3 sm:p-4 md:p-5">
                  <div className="flex justify-between items-start mb-1 sm:mb-2">
                    <h3 className="text-base sm:text-lg font-bold text-bsf-green line-clamp-1">{event.title}</h3>
                  </div>
                  <div className="flex items-center text-xs sm:text-sm text-bsf-gray mb-2 sm:mb-3">
                    <svg className="w-3 h-3 sm:w-4 sm:h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    {event.date}
                  </div>
                  <p className="text-bsf-gray text-xs sm:text-sm line-clamp-2 mb-2 sm:mb-3">
                    {event.description.substring(0, 80)}...
                  </p>
                  <div className="flex justify-end">
                    <span className="text-xs sm:text-sm font-medium text-bsf-red hover:underline">
                      View Details →
                    </span>
                  </div>
                </div>
            ...
            <div className="col-span-full text-center py-10 sm:py-16 md:py-20 bg-gray-50 rounded-xl">
              ...
              <h3 className="mt-2 text-base sm:text-lg font-medium text-bsf-green">No events found</h3>
              <p className="mt-1 text-xs sm:text-sm text-bsf-gray">Try selecting a different category or tab.</p>
            </div>
          )}
        </div>
        ...
        {selectedEvent && (
          <motion.div 
            ...
            className="lg:col-span-5 lg:sticky lg:top-24 self-start bg-white rounded-lg sm:rounded-xl shadow-lg overflow-hidden mt-4 sm:mt-0"
          >
            <div className="relative aspect-video">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5 md:p-6 text-white">
                <span className={`inline-block px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs font-medium mb-1 sm:mb-2 ${
                  activeTab === 'upcoming' ? 'bg-bsf-red/80' : 'bg-bsf-green/80'
                }`}>
            ...
            <div className="p-4 sm:p-5 md:p-6">
              <div className="flex flex-col space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                <div className="flex items-center">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-bsf-green" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <span className="text-xs sm:text-sm text-bsf-gray">{selectedEvent.date}</span>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-xs sm:text-sm text-bsf-gray">{selectedEvent.location}</span>
                </div>
              </div>
              
              <div className="mb-4 sm:mb-6">
                <h3 className="text-base sm:text-lg font-semibold text-bsf-green mb-1 sm:mb-2">About this event</h3>
                <p className="text-bsf-gray text-xs sm:text-sm">{selectedEvent.description}</p>
              </div>
              
              {activeTab === 'past' && selectedEvent.gallery && (
                <div className="mb-4 sm:mb-6">
                  <h3 className="text-base sm:text-lg font-semibold text-bsf-green mb-2 sm:mb-3">Event Gallery</h3>
                  <div className="grid grid-cols-3 gap-1 sm:gap-2">
                    {selectedEvent.gallery.map((image, index) => (
                      <div key={index} className="aspect-square rounded-md sm:rounded-lg overflow-hidden">
                        <img 
                          src={image} 
              ...
              {activeTab === 'upcoming' && (
                <div className="mt-4 sm:mt-6">
                  <a 
                    ...
                    className="block w-full bg-bsf-red hover:bg-bsf-red/90 text-white text-center py-2 sm:py-3 rounded-md sm:rounded-lg text-sm sm:text-base font-medium transition-colors"
                  >
                    Register Now
                  </a>
                </div>
              ...
              {activeTab === 'past' && (
                <Link 
                  to="/gallery" 
                  className="block w-full bg-bsf-green hover:bg-bsf-green/90 text-white text-center py-2 sm:py-3 rounded-md sm:rounded-lg text-sm sm:text-base font-medium transition-colors"
                >
                  View Full Gallery
                </Link>
              )}
      ...
      <div className="mt-10 sm:mt-16 md:mt-20">
        <div className="text-center mb-6 sm:mb-8 md:mb-10">
          <h2 className="text-2xl sm:text-3xl font-bold text-bsf-green">Event Calendar</h2>
          <p className="text-bsf-gray mt-2 text-sm sm:text-base">
        ...
        <div className="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6">
          <div className="flex justify-center items-center mb-4 sm:mb-6 md:mb-8">
            <button className="p-1.5 sm:p-2 rounded-full hover:bg-gray-100">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 text-bsf-gray" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7" />
              </svg>
            </button>
            <h3 className="text-lg sm:text-xl font-bold text-bsf-green px-3 sm:px-6">October 2025</h3>
            <button className="p-1.5 sm:p-2 rounded-full hover:bg-gray-100">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 text-bsf-gray" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* Calendar for medium and larger screens */}
          <div className="hidden sm:block">
            <div className="grid grid-cols-7 gap-1 sm:gap-2 text-center mb-1 sm:mb-2">
              {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((day, index) => (
                <div key={index} className="text-xs sm:text-sm font-medium text-bsf-gray">
                  {day}
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-7 gap-1 sm:gap-2">
              ...
              {[...Array(3)].map((_, index) => (
                <div key={`prev-${index}`} className="aspect-square rounded-md sm:rounded-lg flex items-center justify-center text-gray-400 text-xs sm:text-sm">
                  {28 + index}
                </div>
              ))}
              ...
              {[...Array(31)].map((_, index) => {
                ...
                return (
                  <div 
                    key={`current-${index}`} 
                    className={`aspect-square rounded-md sm:rounded-lg flex flex-col items-center justify-center text-xs sm:text-sm cursor-pointer hover:bg-gray-100 ${
                  ...
                  >
                    {day}
                    {hasEvent && <span className="w-1 h-1 bg-bsf-red rounded-full mt-0.5 sm:mt-1"></span>}
                  </div>
                );
              })}
            </div>
          ...
          <div className="sm:hidden">
            <div className="border border-gray-100 rounded-lg p-3 mb-3">
              <div className="flex justify-between items-center mb-2">
                <div className="text-xs font-medium text-bsf-gray">Oct 10-11, 2025</div>
                <span className="inline-block px-2 py-0.5 rounded-full text-xs font-medium bg-bsf-red/10 text-bsf-red">
                  Workshop
                </span>
              </div>
              <h5 className="font-medium text-sm text-bsf-green">Web Development Bootcamp</h5>
            </div>
            
            <div className="border border-gray-100 rounded-lg p-3">
              <div className="flex justify-between items-center mb-2">
                <div className="text-xs font-medium text-bsf-gray">Oct 25, 2025</div>
                <span className="inline-block px-2 py-0.5 rounded-full text-xs font-medium bg-bsf-red/10 text-bsf-red">
                  Seminar
                </span>
              </div>
              <h5 className="font-medium text-sm text-bsf-green">Tech Talk: Future of AI</h5>
            </div>
          </div>
          
          <div className="mt-4 pt-4 sm:mt-6 sm:pt-6 border-t border-gray-100">
            <h4 className="text-base sm:text-lg font-semibold text-bsf-green mb-2 sm:mb-3">Upcoming in October</h4>
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-start p-2 sm:p-3 rounded-md sm:rounded-lg hover:bg-gray-50">
                <div className="bg-bsf-red/10 text-bsf-red font-bold text-base sm:text-xl w-10 h-10 sm:w-12 sm:h-12 rounded flex items-center justify-center mr-3 sm:mr-4 shrink-0">
                  10
                </div>
                <div>
                  <h5 className="font-medium text-sm sm:text-base text-bsf-green">Web Development Bootcamp</h5>
                  <p className="text-xs sm:text-sm text-bsf-gray">10:00 AM - 4:00 PM, GUB Computer Lab</p>
                </div>
              </div>
              ...
              <div className="flex items-start p-2 sm:p-3 rounded-md sm:rounded-lg hover:bg-gray-50">
                ...
                <div>
                  <h5 className="font-medium text-sm sm:text-base text-bsf-green">Web Development Bootcamp (Day 2)</h5>
                  <p className="text-xs sm:text-sm text-bsf-gray">10:00 AM - 4:00 PM, GUB Computer Lab</p>
                </div>
              </div>
              ...
              <div className="flex items-start p-2 sm:p-3 rounded-md sm:rounded-lg hover:bg-gray-50">
                ...
                <div>
                  <h5 className="font-medium text-sm sm:text-base text-bsf-green">Tech Talk: Future of AI</h5>
                  <p className="text-xs sm:text-sm text-bsf-gray">2:00 PM - 4:00 PM, GUB Auditorium</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Subscription banner */}
      <div className="mt-8 sm:mt-12 md:mt-16 bg-gradient-to-r from-bsf-green to-bsf-teal rounded-xl sm:rounded-2xl shadow-xl overflow-hidden">
        <div className="p-6 sm:p-8 md:p-10">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-4">Never Miss an Event</h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-2 sm:gap-3">
              <a 
                ...
                className="bg-white text-bsf-green hover:bg-gray-100 px-4 sm:px-6 py-2 sm:py-3 rounded-md sm:rounded-lg text-sm sm:text-base font-medium flex items-center justify-center"
              >
